...
pub struct GetCurrentConnectionIDsResponse {
  ...
  pub connection_i_ds: Option<String>,
}
#[derive(ToXml, Debug, Clone, PartialEq)]
...
pub struct GetZoneGroupAttributesResponse {
  ...
  pub current_zone_player_uui_ds_in_group: Option<String>,
...
pub trait AVTransportTrait {
async fn add_multiple_uris_to_queue(&self, request: av_transport::AddMultipleUrisToQueueRequest) -> Result<av_transport::AddMultipleUrisToQueueResponse>;
async fn add_uri_to_queue(&self, request: av_transport::AddUriToQueueRequest) -> Result<av_transport::AddUriToQueueResponse>;
async fn add_uri_to_saved_queue(&self, request: av_transport::AddUriToSavedQueueRequest) -> Result<av_transport::AddUriToSavedQueueResponse>;
async fn backup_queue(&self, request: av_transport::BackupQueueRequest) -> Result<()>;
async fn become_coordinator_of_standalone_group(&self, request: av_transport::BecomeCoordinatorOfStandaloneGroupRequest) -> Result<av_transport::BecomeCoordinatorOfStandaloneGroupResponse>;
async fn become_group_coordinator(&self, request: av_transport::BecomeGroupCoordinatorRequest) -> Result<()>;
async fn become_group_coordinator_and_source(&self, request: av_transport::BecomeGroupCoordinatorAndSourceRequest) -> Result<()>;
async fn change_coordinator(&self, request: av_transport::ChangeCoordinatorRequest) -> Result<()>;
async fn change_transport_settings(&self, request: av_transport::ChangeTransportSettingsRequest) -> Result<()>;
async fn configure_sleep_timer(&self, request: av_transport::ConfigureSleepTimerRequest) -> Result<()>;
async fn create_saved_queue(&self, request: av_transport::CreateSavedQueueRequest) -> Result<av_transport::CreateSavedQueueResponse>;
async fn delegate_group_coordination_to(&self, request: av_transport::DelegateGroupCoordinationToRequest) -> Result<()>;
async fn end_direct_control_session(&self, request: av_transport::EndDirectControlSessionRequest) -> Result<()>;
async fn get_crossfade_mode(&self, request: av_transport::GetCrossfadeModeRequest) -> Result<av_transport::GetCrossfadeModeResponse>;
async fn get_current_transport_actions(&self, request: av_transport::GetCurrentTransportActionsRequest) -> Result<av_transport::GetCurrentTransportActionsResponse>;
async fn get_device_capabilities(&self, request: av_transport::GetDeviceCapabilitiesRequest) -> Result<av_transport::GetDeviceCapabilitiesResponse>;
async fn get_media_info(&self, request: av_transport::GetMediaInfoRequest) -> Result<av_transport::GetMediaInfoResponse>;
async fn get_position_info(&self, request: av_transport::GetPositionInfoRequest) -> Result<av_transport::GetPositionInfoResponse>;
async fn get_remaining_sleep_timer_duration(&self, request: av_transport::GetRemainingSleepTimerDurationRequest) -> Result<av_transport::GetRemainingSleepTimerDurationResponse>;
async fn get_running_alarm_properties(&self, request: av_transport::GetRunningAlarmPropertiesRequest) -> Result<av_transport::GetRunningAlarmPropertiesResponse>;
async fn get_transport_info(&self, request: av_transport::GetTransportInfoRequest) -> Result<av_transport::GetTransportInfoResponse>;
async fn get_transport_settings(&self, request: av_transport::GetTransportSettingsRequest) -> Result<av_transport::GetTransportSettingsResponse>;
async fn next(&self, request: av_transport::NextRequest) -> Result<()>;
async fn notify_deleted_uri(&self, request: av_transport::NotifyDeletedUriRequest) -> Result<()>;
...
async fn remove_all_tracks_from_queue(&self, request: av_transport::RemoveAllTracksFromQueueRequest) -> Result<()>;
async fn remove_track_from_queue(&self, request: av_transport::RemoveTrackFromQueueRequest) -> Result<()>;
async fn remove_track_range_from_queue(&self, request: av_transport::RemoveTrackRangeFromQueueRequest) -> Result<av_transport::RemoveTrackRangeFromQueueResponse>;
async fn reorder_tracks_in_queue(&self, request: av_transport::ReorderTracksInQueueRequest) -> Result<()>;
async fn reorder_tracks_in_saved_queue(&self, request: av_transport::ReorderTracksInSavedQueueRequest) -> Result<av_transport::ReorderTracksInSavedQueueResponse>;
async fn run_alarm(&self, request: av_transport::RunAlarmRequest) -> Result<()>;
async fn save_queue(&self, request: av_transport::SaveQueueRequest) -> Result<av_transport::SaveQueueResponse>;
async fn seek(&self, request: av_transport::SeekRequest) -> Result<()>;
async fn set_av_transport_uri(&self, request: av_transport::SetAvTransportUriRequest) -> Result<()>;
async fn set_crossfade_mode(&self, request: av_transport::SetCrossfadeModeRequest) -> Result<()>;
async fn set_next_av_transport_uri(&self, request: av_transport::SetNextAvTransportUriRequest) -> Result<()>;
...
#[async_trait::async_trait]
pub trait AlarmClockTrait {
async fn create_alarm(&self, request: alarm_clock::CreateAlarmRequest) -> Result<alarm_clock::CreateAlarmResponse>;
async fn destroy_alarm(&self, request: alarm_clock::DestroyAlarmRequest) -> Result<()>;
async fn get_daily_index_refresh_time(&self) -> Result<alarm_clock::GetDailyIndexRefreshTimeResponse>;
async fn get_format(&self) -> Result<alarm_clock::GetFormatResponse>;
async fn get_household_time_at_stamp(&self, request: alarm_clock::GetHouseholdTimeAtStampRequest) -> Result<alarm_clock::GetHouseholdTimeAtStampResponse>;
...
async fn get_time_zone_rule(&self, request: alarm_clock::GetTimeZoneRuleRequest) -> Result<alarm_clock::GetTimeZoneRuleResponse>;
async fn list_alarms(&self) -> Result<alarm_clock::ListAlarmsResponse>;
async fn set_daily_index_refresh_time(&self, request: alarm_clock::SetDailyIndexRefreshTimeRequest) -> Result<()>;
...
#[async_trait::async_trait]
pub trait AudioInTrait {
async fn get_audio_input_attributes(&self) -> Result<audio_in::GetAudioInputAttributesResponse>;
...
async fn set_audio_input_attributes(&self, request: audio_in::SetAudioInputAttributesRequest) -> Result<()>;
async fn set_line_in_level(&self, request: audio_in::SetLineInLevelRequest) -> Result<()>;
async fn start_transmission_to_group(&self, request: audio_in::StartTransmissionToGroupRequest) -> Result<audio_in::StartTransmissionToGroupResponse>;
async fn stop_transmission_to_group(&self, request: audio_in::StopTransmissionToGroupRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait ConnectionManagerTrait {
async fn get_current_connection_i_ds(&self) -> Result<connection_manager::GetCurrentConnectionIDsResponse>;
async fn get_current_connection_info(&self, request: connection_manager::GetCurrentConnectionInfoRequest) -> Result<connection_manager::GetCurrentConnectionInfoResponse>;
async fn get_protocol_info(&self) -> Result<connection_manager::GetProtocolInfoResponse>;
}
#[async_trait::async_trait]
pub trait ContentDirectoryTrait {
async fn browse(&self, request: content_directory::BrowseRequest) -> Result<content_directory::BrowseResponse>;
async fn create_object(&self, request: content_directory::CreateObjectRequest) -> Result<content_directory::CreateObjectResponse>;
async fn destroy_object(&self, request: content_directory::DestroyObjectRequest) -> Result<()>;
async fn find_prefix(&self, request: content_directory::FindPrefixRequest) -> Result<content_directory::FindPrefixResponse>;
async fn get_album_artist_display_option(&self) -> Result<content_directory::GetAlbumArtistDisplayOptionResponse>;
async fn get_all_prefix_locations(&self, request: content_directory::GetAllPrefixLocationsRequest) -> Result<content_directory::GetAllPrefixLocationsResponse>;
...
async fn get_search_capabilities(&self) -> Result<content_directory::GetSearchCapabilitiesResponse>;
async fn get_share_index_in_progress(&self) -> Result<content_directory::GetShareIndexInProgressResponse>;
async fn get_sort_capabilities(&self) -> Result<content_directory::GetSortCapabilitiesResponse>;
async fn get_system_update_id(&self) -> Result<content_directory::GetSystemUpdateIdResponse>;
async fn refresh_share_index(&self, request: content_directory::RefreshShareIndexRequest) -> Result<()>;
...
#[async_trait::async_trait]
pub trait DevicePropertiesTrait {
async fn add_bonded_zones(&self, request: device_properties::AddBondedZonesRequest) -> Result<()>;
async fn add_ht_satellite(&self, request: device_properties::AddHtSatelliteRequest) -> Result<()>;
async fn create_stereo_pair(&self, request: device_properties::CreateStereoPairRequest) -> Result<()>;
async fn enter_config_mode(&self, request: device_properties::EnterConfigModeRequest) -> Result<device_properties::EnterConfigModeResponse>;
async fn exit_config_mode(&self, request: device_properties::ExitConfigModeRequest) -> Result<()>;
async fn get_autoplay_linked_zones(&self, request: device_properties::GetAutoplayLinkedZonesRequest) -> Result<device_properties::GetAutoplayLinkedZonesResponse>;
async fn get_autoplay_room_uuid(&self, request: device_properties::GetAutoplayRoomUuidRequest) -> Result<device_properties::GetAutoplayRoomUuidResponse>;
async fn get_autoplay_volume(&self, request: device_properties::GetAutoplayVolumeRequest) -> Result<device_properties::GetAutoplayVolumeResponse>;
...
async fn get_use_autoplay_volume(&self, request: device_properties::GetUseAutoplayVolumeRequest) -> Result<device_properties::GetUseAutoplayVolumeResponse>;
...
async fn remove_bonded_zones(&self, request: device_properties::RemoveBondedZonesRequest) -> Result<()>;
async fn remove_ht_satellite(&self, request: device_properties::RemoveHtSatelliteRequest) -> Result<()>;
async fn room_detection_start_chirping(&self, request: device_properties::RoomDetectionStartChirpingRequest) -> Result<device_properties::RoomDetectionStartChirpingResponse>;
async fn room_detection_stop_chirping(&self, request: device_properties::RoomDetectionStopChirpingRequest) -> Result<()>;
async fn separate_stereo_pair(&self, request: device_properties::SeparateStereoPairRequest) -> Result<()>;
async fn set_autoplay_linked_zones(&self, request: device_properties::SetAutoplayLinkedZonesRequest) -> Result<()>;
async fn set_autoplay_room_uuid(&self, request: device_properties::SetAutoplayRoomUuidRequest) -> Result<()>;
async fn set_autoplay_volume(&self, request: device_properties::SetAutoplayVolumeRequest) -> Result<()>;
async fn set_button_lock_state(&self, request: device_properties::SetButtonLockStateRequest) -> Result<()>;
async fn set_led_state(&self, request: device_properties::SetLedStateRequest) -> Result<()>;
async fn set_use_autoplay_volume(&self, request: device_properties::SetUseAutoplayVolumeRequest) -> Result<()>;
async fn set_zone_attributes(&self, request: device_properties::SetZoneAttributesRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait GroupManagementTrait {
async fn add_member(&self, request: group_management::AddMemberRequest) -> Result<group_management::AddMemberResponse>;
async fn remove_member(&self, request: group_management::RemoveMemberRequest) -> Result<()>;
async fn report_track_buffering_result(&self, request: group_management::ReportTrackBufferingResultRequest) -> Result<()>;
async fn set_source_area_ids(&self, request: group_management::SetSourceAreaIdsRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait GroupRenderingControlTrait {
async fn get_group_mute(&self, request: group_rendering_control::GetGroupMuteRequest) -> Result<group_rendering_control::GetGroupMuteResponse>;
async fn get_group_volume(&self, request: group_rendering_control::GetGroupVolumeRequest) -> Result<group_rendering_control::GetGroupVolumeResponse>;
async fn set_group_mute(&self, request: group_rendering_control::SetGroupMuteRequest) -> Result<()>;
async fn set_group_volume(&self, request: group_rendering_control::SetGroupVolumeRequest) -> Result<()>;
async fn set_relative_group_volume(&self, request: group_rendering_control::SetRelativeGroupVolumeRequest) -> Result<group_rendering_control::SetRelativeGroupVolumeResponse>;
async fn snapshot_group_volume(&self, request: group_rendering_control::SnapshotGroupVolumeRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait HTControlTrait {
async fn commit_learned_ir_codes(&self, request: ht_control::CommitLearnedIrCodesRequest) -> Result<()>;
...
async fn set_ir_repeater_state(&self, request: ht_control::SetIrRepeaterStateRequest) -> Result<()>;
async fn set_led_feedback_state(&self, request: ht_control::SetLedFeedbackStateRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait MusicServicesTrait {
async fn get_session_id(&self, request: music_services::GetSessionIdRequest) -> Result<music_services::GetSessionIdResponse>;
async fn list_available_services(&self) -> Result<music_services::ListAvailableServicesResponse>;
async fn update_available_services(&self) -> Result<()>;
}
#[async_trait::async_trait]
pub trait QPlayTrait {
async fn q_play_auth(&self, request: q_play::QPlayAuthRequest) -> Result<q_play::QPlayAuthResponse>;
}
#[async_trait::async_trait]
pub trait QueueTrait {
async fn add_multiple_uris(&self, request: queue::AddMultipleUrisRequest) -> Result<queue::AddMultipleUrisResponse>;
async fn add_uri(&self, request: queue::AddUriRequest) -> Result<queue::AddUriResponse>;
async fn attach_queue(&self, request: queue::AttachQueueRequest) -> Result<queue::AttachQueueResponse>;
async fn backup(&self) -> Result<()>;
async fn browse(&self, request: queue::BrowseRequest) -> Result<queue::BrowseResponse>;
async fn create_queue(&self, request: queue::CreateQueueRequest) -> Result<queue::CreateQueueResponse>;
async fn remove_all_tracks(&self, request: queue::RemoveAllTracksRequest) -> Result<queue::RemoveAllTracksResponse>;
async fn remove_track_range(&self, request: queue::RemoveTrackRangeRequest) -> Result<queue::RemoveTrackRangeResponse>;
async fn reorder_tracks(&self, request: queue::ReorderTracksRequest) -> Result<queue::ReorderTracksResponse>;
async fn replace_all_tracks(&self, request: queue::ReplaceAllTracksRequest) -> Result<queue::ReplaceAllTracksResponse>;
async fn save_as_sonos_playlist(&self, request: queue::SaveAsSonosPlaylistRequest) -> Result<queue::SaveAsSonosPlaylistResponse>;
}
#[async_trait::async_trait]
pub trait RenderingControlTrait {
async fn get_bass(&self, request: rendering_control::GetBassRequest) -> Result<rendering_control::GetBassResponse>;
async fn get_eq(&self, request: rendering_control::GetEqRequest) -> Result<rendering_control::GetEqResponse>;
async fn get_headphone_connected(&self, request: rendering_control::GetHeadphoneConnectedRequest) -> Result<rendering_control::GetHeadphoneConnectedResponse>;
async fn get_loudness(&self, request: rendering_control::GetLoudnessRequest) -> Result<rendering_control::GetLoudnessResponse>;
async fn get_mute(&self, request: rendering_control::GetMuteRequest) -> Result<rendering_control::GetMuteResponse>;
async fn get_output_fixed(&self, request: rendering_control::GetOutputFixedRequest) -> Result<rendering_control::GetOutputFixedResponse>;
async fn get_room_calibration_status(&self, request: rendering_control::GetRoomCalibrationStatusRequest) -> Result<rendering_control::GetRoomCalibrationStatusResponse>;
async fn get_supports_output_fixed(&self, request: rendering_control::GetSupportsOutputFixedRequest) -> Result<rendering_control::GetSupportsOutputFixedResponse>;
async fn get_treble(&self, request: rendering_control::GetTrebleRequest) -> Result<rendering_control::GetTrebleResponse>;
async fn get_volume(&self, request: rendering_control::GetVolumeRequest) -> Result<rendering_control::GetVolumeResponse>;
async fn get_volume_db(&self, request: rendering_control::GetVolumeDbRequest) -> Result<rendering_control::GetVolumeDbResponse>;
async fn get_volume_db_range(&self, request: rendering_control::GetVolumeDbRangeRequest) -> Result<rendering_control::GetVolumeDbRangeResponse>;
async fn ramp_to_volume(&self, request: rendering_control::RampToVolumeRequest) -> Result<rendering_control::RampToVolumeResponse>;
async fn reset_basic_eq(&self, request: rendering_control::ResetBasicEqRequest) -> Result<rendering_control::ResetBasicEqResponse>;
async fn reset_ext_eq(&self, request: rendering_control::ResetExtEqRequest) -> Result<()>;
async fn restore_volume_prior_to_ramp(&self, request: rendering_control::RestoreVolumePriorToRampRequest) -> Result<()>;
async fn set_bass(&self, request: rendering_control::SetBassRequest) -> Result<()>;
async fn set_channel_map(&self, request: rendering_control::SetChannelMapRequest) -> Result<()>;
...
async fn set_output_fixed(&self, request: rendering_control::SetOutputFixedRequest) -> Result<()>;
async fn set_relative_volume(&self, request: rendering_control::SetRelativeVolumeRequest) -> Result<rendering_control::SetRelativeVolumeResponse>;
async fn set_room_calibration_status(&self, request: rendering_control::SetRoomCalibrationStatusRequest) -> Result<()>;
async fn set_room_calibration_x(&self, request: rendering_control::SetRoomCalibrationXRequest) -> Result<()>;
...
#[async_trait::async_trait]
pub trait SystemPropertiesTrait {
async fn add_account_x(&self, request: system_properties::AddAccountXRequest) -> Result<system_properties::AddAccountXResponse>;
async fn add_o_auth_account_x(&self, request: system_properties::AddOAuthAccountXRequest) -> Result<system_properties::AddOAuthAccountXResponse>;
async fn do_post_update_tasks(&self) -> Result<()>;
async fn edit_account_md(&self, request: system_properties::EditAccountMdRequest) -> Result<()>;
async fn edit_account_password_x(&self, request: system_properties::EditAccountPasswordXRequest) -> Result<()>;
...
async fn get_string(&self, request: system_properties::GetStringRequest) -> Result<system_properties::GetStringResponse>;
async fn get_web_code(&self, request: system_properties::GetWebCodeRequest) -> Result<system_properties::GetWebCodeResponse>;
async fn provision_credentialed_trial_account_x(&self, request: system_properties::ProvisionCredentialedTrialAccountXRequest) -> Result<system_properties::ProvisionCredentialedTrialAccountXResponse>;
async fn refresh_account_credentials_x(&self, request: system_properties::RefreshAccountCredentialsXRequest) -> Result<()>;
...
async fn replace_account_x(&self, request: system_properties::ReplaceAccountXRequest) -> Result<system_properties::ReplaceAccountXResponse>;
async fn reset_third_party_credentials(&self) -> Result<()>;
async fn set_account_nickname_x(&self, request: system_properties::SetAccountNicknameXRequest) -> Result<()>;
async fn set_string(&self, request: system_properties::SetStringRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait VirtualLineInTrait {
...
async fn start_transmission(&self, request: virtual_line_in::StartTransmissionRequest) -> Result<virtual_line_in::StartTransmissionResponse>;
async fn stop(&self, request: virtual_line_in::StopRequest) -> Result<()>;
async fn stop_transmission(&self, request: virtual_line_in::StopTransmissionRequest) -> Result<()>;
}
#[async_trait::async_trait]
pub trait ZoneGroupTopologyTrait {
async fn begin_software_update(&self, request: zone_group_topology::BeginSoftwareUpdateRequest) -> Result<()>;
async fn check_for_update(&self, request: zone_group_topology::CheckForUpdateRequest) -> Result<zone_group_topology::CheckForUpdateResponse>;
async fn get_zone_group_attributes(&self) -> Result<zone_group_topology::GetZoneGroupAttributesResponse>;
async fn get_zone_group_state(&self) -> Result<zone_group_topology::GetZoneGroupStateResponse>;
async fn register_mobile_device(&self, request: zone_group_topology::RegisterMobileDeviceRequest) -> Result<()>;
async fn report_alarm_started_running(&self) -> Result<()>;
async fn report_unresponsive_device(&self, request: zone_group_topology::ReportUnresponsiveDeviceRequest) -> Result<()>;
async fn submit_diagnostics(&self, request: zone_group_topology::SubmitDiagnosticsRequest) -> Result<zone_group_topology::SubmitDiagnosticsResponse>;
}

#[async_trait::async_trait]
impl AVTransportTrait for SonosDevice {
async fn add_multiple_uris_to_queue(&self, request: av_transport::AddMultipleUrisToQueueRequest) -> Result<av_transport::AddMultipleUrisToQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "AddMultipleURIsToQueue", request).await
}

async fn add_uri_to_queue(&self, request: av_transport::AddUriToQueueRequest) -> Result<av_transport::AddUriToQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "AddURIToQueue", request).await
}

async fn add_uri_to_saved_queue(&self, request: av_transport::AddUriToSavedQueueRequest) -> Result<av_transport::AddUriToSavedQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "AddURIToSavedQueue", request).await
}

async fn backup_queue(&self, request: av_transport::BackupQueueRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "BackupQueue", request).await
}

async fn become_coordinator_of_standalone_group(&self, request: av_transport::BecomeCoordinatorOfStandaloneGroupRequest) -> Result<av_transport::BecomeCoordinatorOfStandaloneGroupResponse> {
  self.action(&av_transport::SERVICE_TYPE, "BecomeCoordinatorOfStandaloneGroup", request).await
}

async fn become_group_coordinator(&self, request: av_transport::BecomeGroupCoordinatorRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "BecomeGroupCoordinator", request).await
}

async fn become_group_coordinator_and_source(&self, request: av_transport::BecomeGroupCoordinatorAndSourceRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "BecomeGroupCoordinatorAndSource", request).await
}

async fn change_coordinator(&self, request: av_transport::ChangeCoordinatorRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "ChangeCoordinator", request).await
}

async fn change_transport_settings(&self, request: av_transport::ChangeTransportSettingsRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "ChangeTransportSettings", request).await
}

async fn configure_sleep_timer(&self, request: av_transport::ConfigureSleepTimerRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "ConfigureSleepTimer", request).await
}

async fn create_saved_queue(&self, request: av_transport::CreateSavedQueueRequest) -> Result<av_transport::CreateSavedQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "CreateSavedQueue", request).await
}

async fn delegate_group_coordination_to(&self, request: av_transport::DelegateGroupCoordinationToRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "DelegateGroupCoordinationTo", request).await
}

async fn end_direct_control_session(&self, request: av_transport::EndDirectControlSessionRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "EndDirectControlSession", request).await
}

async fn get_crossfade_mode(&self, request: av_transport::GetCrossfadeModeRequest) -> Result<av_transport::GetCrossfadeModeResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetCrossfadeMode", request).await
}

async fn get_current_transport_actions(&self, request: av_transport::GetCurrentTransportActionsRequest) -> Result<av_transport::GetCurrentTransportActionsResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetCurrentTransportActions", request).await
}

async fn get_device_capabilities(&self, request: av_transport::GetDeviceCapabilitiesRequest) -> Result<av_transport::GetDeviceCapabilitiesResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetDeviceCapabilities", request).await
}

async fn get_media_info(&self, request: av_transport::GetMediaInfoRequest) -> Result<av_transport::GetMediaInfoResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetMediaInfo", request).await
}

async fn get_position_info(&self, request: av_transport::GetPositionInfoRequest) -> Result<av_transport::GetPositionInfoResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetPositionInfo", request).await
}

async fn get_remaining_sleep_timer_duration(&self, request: av_transport::GetRemainingSleepTimerDurationRequest) -> Result<av_transport::GetRemainingSleepTimerDurationResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetRemainingSleepTimerDuration", request).await
}

async fn get_running_alarm_properties(&self, request: av_transport::GetRunningAlarmPropertiesRequest) -> Result<av_transport::GetRunningAlarmPropertiesResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetRunningAlarmProperties", request).await
}

async fn get_transport_info(&self, request: av_transport::GetTransportInfoRequest) -> Result<av_transport::GetTransportInfoResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetTransportInfo", request).await
}

async fn get_transport_settings(&self, request: av_transport::GetTransportSettingsRequest) -> Result<av_transport::GetTransportSettingsResponse> {
  self.action(&av_transport::SERVICE_TYPE, "GetTransportSettings", request).await
}

async fn next(&self, request: av_transport::NextRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "Next", request).await
}

async fn notify_deleted_uri(&self, request: av_transport::NotifyDeletedUriRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "NotifyDeletedURI", request).await
}

async fn pause(&self, request: av_transport::PauseRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "Pause", request).await
}

async fn play(&self, request: av_transport::PlayRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "Play", request).await
}

async fn previous(&self, request: av_transport::PreviousRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "Previous", request).await
}

async fn remove_all_tracks_from_queue(&self, request: av_transport::RemoveAllTracksFromQueueRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "RemoveAllTracksFromQueue", request).await
}

async fn remove_track_from_queue(&self, request: av_transport::RemoveTrackFromQueueRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "RemoveTrackFromQueue", request).await
}

async fn remove_track_range_from_queue(&self, request: av_transport::RemoveTrackRangeFromQueueRequest) -> Result<av_transport::RemoveTrackRangeFromQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "RemoveTrackRangeFromQueue", request).await
}

async fn reorder_tracks_in_queue(&self, request: av_transport::ReorderTracksInQueueRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "ReorderTracksInQueue", request).await
}

async fn reorder_tracks_in_saved_queue(&self, request: av_transport::ReorderTracksInSavedQueueRequest) -> Result<av_transport::ReorderTracksInSavedQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "ReorderTracksInSavedQueue", request).await
}

async fn run_alarm(&self, request: av_transport::RunAlarmRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "RunAlarm", request).await
}

async fn save_queue(&self, request: av_transport::SaveQueueRequest) -> Result<av_transport::SaveQueueResponse> {
  self.action(&av_transport::SERVICE_TYPE, "SaveQueue", request).await
}

async fn seek(&self, request: av_transport::SeekRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "Seek", request).await
}

async fn set_av_transport_uri(&self, request: av_transport::SetAvTransportUriRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "SetAVTransportURI", request).await
}

async fn set_crossfade_mode(&self, request: av_transport::SetCrossfadeModeRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "SetCrossfadeMode", request).await
}

async fn set_next_av_transport_uri(&self, request: av_transport::SetNextAvTransportUriRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "SetNextAVTransportURI", request).await
}

async fn set_play_mode(&self, request: av_transport::SetPlayModeRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "SetPlayMode", request).await
}

async fn snooze_alarm(&self, request: av_transport::SnoozeAlarmRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "SnoozeAlarm", request).await
}

async fn start_autoplay(&self, request: av_transport::StartAutoplayRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "StartAutoplay", request).await
}

async fn stop(&self, request: av_transport::StopRequest) -> Result<()> {
  self.action(&av_transport::SERVICE_TYPE, "Stop", request).await
}

}
#[async_trait::async_trait]
impl AlarmClockTrait for SonosDevice {
async fn create_alarm(&self, request: alarm_clock::CreateAlarmRequest) -> Result<alarm_clock::CreateAlarmResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "CreateAlarm", request).await
}

async fn destroy_alarm(&self, request: alarm_clock::DestroyAlarmRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "DestroyAlarm", request).await
}

async fn get_daily_index_refresh_time(&self) -> Result<alarm_clock::GetDailyIndexRefreshTimeResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetDailyIndexRefreshTime", crate::soap::Unit{}).await
}

async fn get_format(&self) -> Result<alarm_clock::GetFormatResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetFormat", crate::soap::Unit{}).await
}

async fn get_household_time_at_stamp(&self, request: alarm_clock::GetHouseholdTimeAtStampRequest) -> Result<alarm_clock::GetHouseholdTimeAtStampResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetHouseholdTimeAtStamp", request).await
}

async fn get_time_now(&self) -> Result<alarm_clock::GetTimeNowResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetTimeNow", crate::soap::Unit{}).await
}

async fn get_time_server(&self) -> Result<alarm_clock::GetTimeServerResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetTimeServer", crate::soap::Unit{}).await
}

async fn get_time_zone(&self) -> Result<alarm_clock::GetTimeZoneResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetTimeZone", crate::soap::Unit{}).await
}

async fn get_time_zone_and_rule(&self) -> Result<alarm_clock::GetTimeZoneAndRuleResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetTimeZoneAndRule", crate::soap::Unit{}).await
}

async fn get_time_zone_rule(&self, request: alarm_clock::GetTimeZoneRuleRequest) -> Result<alarm_clock::GetTimeZoneRuleResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "GetTimeZoneRule", request).await
}

async fn list_alarms(&self) -> Result<alarm_clock::ListAlarmsResponse> {
  self.action(&alarm_clock::SERVICE_TYPE, "ListAlarms", crate::soap::Unit{}).await
}

async fn set_daily_index_refresh_time(&self, request: alarm_clock::SetDailyIndexRefreshTimeRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "SetDailyIndexRefreshTime", request).await
}

async fn set_format(&self, request: alarm_clock::SetFormatRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "SetFormat", request).await
}

async fn set_time_now(&self, request: alarm_clock::SetTimeNowRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "SetTimeNow", request).await
}

async fn set_time_server(&self, request: alarm_clock::SetTimeServerRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "SetTimeServer", request).await
}

async fn set_time_zone(&self, request: alarm_clock::SetTimeZoneRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "SetTimeZone", request).await
}

async fn update_alarm(&self, request: alarm_clock::UpdateAlarmRequest) -> Result<()> {
  self.action(&alarm_clock::SERVICE_TYPE, "UpdateAlarm", request).await
}

}
#[async_trait::async_trait]
impl AudioInTrait for SonosDevice {
async fn get_audio_input_attributes(&self) -> Result<audio_in::GetAudioInputAttributesResponse> {
  self.action(&audio_in::SERVICE_TYPE, "GetAudioInputAttributes", crate::soap::Unit{}).await
}

async fn get_line_in_level(&self) -> Result<audio_in::GetLineInLevelResponse> {
  self.action(&audio_in::SERVICE_TYPE, "GetLineInLevel", crate::soap::Unit{}).await
}

async fn select_audio(&self, request: audio_in::SelectAudioRequest) -> Result<()> {
  self.action(&audio_in::SERVICE_TYPE, "SelectAudio", request).await
}

async fn set_audio_input_attributes(&self, request: audio_in::SetAudioInputAttributesRequest) -> Result<()> {
  self.action(&audio_in::SERVICE_TYPE, "SetAudioInputAttributes", request).await
}

async fn set_line_in_level(&self, request: audio_in::SetLineInLevelRequest) -> Result<()> {
  self.action(&audio_in::SERVICE_TYPE, "SetLineInLevel", request).await
}

async fn start_transmission_to_group(&self, request: audio_in::StartTransmissionToGroupRequest) -> Result<audio_in::StartTransmissionToGroupResponse> {
  self.action(&audio_in::SERVICE_TYPE, "StartTransmissionToGroup", request).await
}

async fn stop_transmission_to_group(&self, request: audio_in::StopTransmissionToGroupRequest) -> Result<()> {
  self.action(&audio_in::SERVICE_TYPE, "StopTransmissionToGroup", request).await
}

}
#[async_trait::async_trait]
impl ConnectionManagerTrait for SonosDevice {
async fn get_current_connection_i_ds(&self) -> Result<connection_manager::GetCurrentConnectionIDsResponse> {
  self.action(&connection_manager::SERVICE_TYPE, "GetCurrentConnectionIDs", crate::soap::Unit{}).await
}

async fn get_current_connection_info(&self, request: connection_manager::GetCurrentConnectionInfoRequest) -> Result<connection_manager::GetCurrentConnectionInfoResponse> {
  self.action(&connection_manager::SERVICE_TYPE, "GetCurrentConnectionInfo", request).await
}

async fn get_protocol_info(&self) -> Result<connection_manager::GetProtocolInfoResponse> {
  self.action(&connection_manager::SERVICE_TYPE, "GetProtocolInfo", crate::soap::Unit{}).await
}

}
#[async_trait::async_trait]
impl ContentDirectoryTrait for SonosDevice {
async fn browse(&self, request: content_directory::BrowseRequest) -> Result<content_directory::BrowseResponse> {
  self.action(&content_directory::SERVICE_TYPE, "Browse", request).await
}

async fn create_object(&self, request: content_directory::CreateObjectRequest) -> Result<content_directory::CreateObjectResponse> {
  self.action(&content_directory::SERVICE_TYPE, "CreateObject", request).await
}

async fn destroy_object(&self, request: content_directory::DestroyObjectRequest) -> Result<()> {
  self.action(&content_directory::SERVICE_TYPE, "DestroyObject", request).await
}

async fn find_prefix(&self, request: content_directory::FindPrefixRequest) -> Result<content_directory::FindPrefixResponse> {
  self.action(&content_directory::SERVICE_TYPE, "FindPrefix", request).await
}

async fn get_album_artist_display_option(&self) -> Result<content_directory::GetAlbumArtistDisplayOptionResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetAlbumArtistDisplayOption", crate::soap::Unit{}).await
}

async fn get_all_prefix_locations(&self, request: content_directory::GetAllPrefixLocationsRequest) -> Result<content_directory::GetAllPrefixLocationsResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetAllPrefixLocations", request).await
}

async fn get_browseable(&self) -> Result<content_directory::GetBrowseableResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetBrowseable", crate::soap::Unit{}).await
}

async fn get_last_index_change(&self) -> Result<content_directory::GetLastIndexChangeResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetLastIndexChange", crate::soap::Unit{}).await
}

async fn get_search_capabilities(&self) -> Result<content_directory::GetSearchCapabilitiesResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetSearchCapabilities", crate::soap::Unit{}).await
}

async fn get_share_index_in_progress(&self) -> Result<content_directory::GetShareIndexInProgressResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetShareIndexInProgress", crate::soap::Unit{}).await
}

async fn get_sort_capabilities(&self) -> Result<content_directory::GetSortCapabilitiesResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetSortCapabilities", crate::soap::Unit{}).await
}

async fn get_system_update_id(&self) -> Result<content_directory::GetSystemUpdateIdResponse> {
  self.action(&content_directory::SERVICE_TYPE, "GetSystemUpdateID", crate::soap::Unit{}).await
}

async fn refresh_share_index(&self, request: content_directory::RefreshShareIndexRequest) -> Result<()> {
  self.action(&content_directory::SERVICE_TYPE, "RefreshShareIndex", request).await
}

async fn request_resort(&self, request: content_directory::RequestResortRequest) -> Result<()> {
  self.action(&content_directory::SERVICE_TYPE, "RequestResort", request).await
}

async fn set_browseable(&self, request: content_directory::SetBrowseableRequest) -> Result<()> {
  self.action(&content_directory::SERVICE_TYPE, "SetBrowseable", request).await
}

async fn update_object(&self, request: content_directory::UpdateObjectRequest) -> Result<()> {
  self.action(&content_directory::SERVICE_TYPE, "UpdateObject", request).await
}

}
#[async_trait::async_trait]
impl DevicePropertiesTrait for SonosDevice {
async fn add_bonded_zones(&self, request: device_properties::AddBondedZonesRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "AddBondedZones", request).await
}

async fn add_ht_satellite(&self, request: device_properties::AddHtSatelliteRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "AddHTSatellite", request).await
}

async fn create_stereo_pair(&self, request: device_properties::CreateStereoPairRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "CreateStereoPair", request).await
}

async fn enter_config_mode(&self, request: device_properties::EnterConfigModeRequest) -> Result<device_properties::EnterConfigModeResponse> {
  self.action(&device_properties::SERVICE_TYPE, "EnterConfigMode", request).await
}

async fn exit_config_mode(&self, request: device_properties::ExitConfigModeRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "ExitConfigMode", request).await
}

async fn get_autoplay_linked_zones(&self, request: device_properties::GetAutoplayLinkedZonesRequest) -> Result<device_properties::GetAutoplayLinkedZonesResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetAutoplayLinkedZones", request).await
}

async fn get_autoplay_room_uuid(&self, request: device_properties::GetAutoplayRoomUuidRequest) -> Result<device_properties::GetAutoplayRoomUuidResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetAutoplayRoomUUID", request).await
}

async fn get_autoplay_volume(&self, request: device_properties::GetAutoplayVolumeRequest) -> Result<device_properties::GetAutoplayVolumeResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetAutoplayVolume", request).await
}

async fn get_button_lock_state(&self) -> Result<device_properties::GetButtonLockStateResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetButtonLockState", crate::soap::Unit{}).await
}

async fn get_button_state(&self) -> Result<device_properties::GetButtonStateResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetButtonState", crate::soap::Unit{}).await
}

async fn get_ht_forward_state(&self) -> Result<device_properties::GetHtForwardStateResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetHTForwardState", crate::soap::Unit{}).await
}

async fn get_household_id(&self) -> Result<device_properties::GetHouseholdIdResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetHouseholdID", crate::soap::Unit{}).await
}

async fn get_led_state(&self) -> Result<device_properties::GetLedStateResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetLEDState", crate::soap::Unit{}).await
}

async fn get_use_autoplay_volume(&self, request: device_properties::GetUseAutoplayVolumeRequest) -> Result<device_properties::GetUseAutoplayVolumeResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetUseAutoplayVolume", request).await
}

async fn get_zone_attributes(&self) -> Result<device_properties::GetZoneAttributesResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetZoneAttributes", crate::soap::Unit{}).await
}

async fn get_zone_info(&self) -> Result<device_properties::GetZoneInfoResponse> {
  self.action(&device_properties::SERVICE_TYPE, "GetZoneInfo", crate::soap::Unit{}).await
}

async fn remove_bonded_zones(&self, request: device_properties::RemoveBondedZonesRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "RemoveBondedZones", request).await
}

async fn remove_ht_satellite(&self, request: device_properties::RemoveHtSatelliteRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "RemoveHTSatellite", request).await
}

async fn room_detection_start_chirping(&self, request: device_properties::RoomDetectionStartChirpingRequest) -> Result<device_properties::RoomDetectionStartChirpingResponse> {
  self.action(&device_properties::SERVICE_TYPE, "RoomDetectionStartChirping", request).await
}

async fn room_detection_stop_chirping(&self, request: device_properties::RoomDetectionStopChirpingRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "RoomDetectionStopChirping", request).await
}

async fn separate_stereo_pair(&self, request: device_properties::SeparateStereoPairRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SeparateStereoPair", request).await
}

async fn set_autoplay_linked_zones(&self, request: device_properties::SetAutoplayLinkedZonesRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetAutoplayLinkedZones", request).await
}

async fn set_autoplay_room_uuid(&self, request: device_properties::SetAutoplayRoomUuidRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetAutoplayRoomUUID", request).await
}

async fn set_autoplay_volume(&self, request: device_properties::SetAutoplayVolumeRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetAutoplayVolume", request).await
}

async fn set_button_lock_state(&self, request: device_properties::SetButtonLockStateRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetButtonLockState", request).await
}

async fn set_led_state(&self, request: device_properties::SetLedStateRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetLEDState", request).await
}

async fn set_use_autoplay_volume(&self, request: device_properties::SetUseAutoplayVolumeRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetUseAutoplayVolume", request).await
}

async fn set_zone_attributes(&self, request: device_properties::SetZoneAttributesRequest) -> Result<()> {
  self.action(&device_properties::SERVICE_TYPE, "SetZoneAttributes", request).await
}

}
#[async_trait::async_trait]
impl GroupManagementTrait for SonosDevice {
async fn add_member(&self, request: group_management::AddMemberRequest) -> Result<group_management::AddMemberResponse> {
  self.action(&group_management::SERVICE_TYPE, "AddMember", request).await
}

async fn remove_member(&self, request: group_management::RemoveMemberRequest) -> Result<()> {
  self.action(&group_management::SERVICE_TYPE, "RemoveMember", request).await
}

async fn report_track_buffering_result(&self, request: group_management::ReportTrackBufferingResultRequest) -> Result<()> {
  self.action(&group_management::SERVICE_TYPE, "ReportTrackBufferingResult", request).await
}

async fn set_source_area_ids(&self, request: group_management::SetSourceAreaIdsRequest) -> Result<()> {
  self.action(&group_management::SERVICE_TYPE, "SetSourceAreaIds", request).await
}

}
#[async_trait::async_trait]
impl GroupRenderingControlTrait for SonosDevice {
async fn get_group_mute(&self, request: group_rendering_control::GetGroupMuteRequest) -> Result<group_rendering_control::GetGroupMuteResponse> {
  self.action(&group_rendering_control::SERVICE_TYPE, "GetGroupMute", request).await
}

async fn get_group_volume(&self, request: group_rendering_control::GetGroupVolumeRequest) -> Result<group_rendering_control::GetGroupVolumeResponse> {
  self.action(&group_rendering_control::SERVICE_TYPE, "GetGroupVolume", request).await
}

async fn set_group_mute(&self, request: group_rendering_control::SetGroupMuteRequest) -> Result<()> {
  self.action(&group_rendering_control::SERVICE_TYPE, "SetGroupMute", request).await
}

async fn set_group_volume(&self, request: group_rendering_control::SetGroupVolumeRequest) -> Result<()> {
  self.action(&group_rendering_control::SERVICE_TYPE, "SetGroupVolume", request).await
}

async fn set_relative_group_volume(&self, request: group_rendering_control::SetRelativeGroupVolumeRequest) -> Result<group_rendering_control::SetRelativeGroupVolumeResponse> {
  self.action(&group_rendering_control::SERVICE_TYPE, "SetRelativeGroupVolume", request).await
}

async fn snapshot_group_volume(&self, request: group_rendering_control::SnapshotGroupVolumeRequest) -> Result<()> {
  self.action(&group_rendering_control::SERVICE_TYPE, "SnapshotGroupVolume", request).await
}

}
#[async_trait::async_trait]
impl HTControlTrait for SonosDevice {
async fn commit_learned_ir_codes(&self, request: ht_control::CommitLearnedIrCodesRequest) -> Result<()> {
  self.action(&ht_control::SERVICE_TYPE, "CommitLearnedIRCodes", request).await
}

async fn get_ir_repeater_state(&self) -> Result<ht_control::GetIrRepeaterStateResponse> {
  self.action(&ht_control::SERVICE_TYPE, "GetIRRepeaterState", crate::soap::Unit{}).await
}

async fn get_led_feedback_state(&self) -> Result<ht_control::GetLedFeedbackStateResponse> {
  self.action(&ht_control::SERVICE_TYPE, "GetLEDFeedbackState", crate::soap::Unit{}).await
}

async fn identify_ir_remote(&self, request: ht_control::IdentifyIrRemoteRequest) -> Result<()> {
  self.action(&ht_control::SERVICE_TYPE, "IdentifyIRRemote", request).await
}

async fn is_remote_configured(&self) -> Result<ht_control::IsRemoteConfiguredResponse> {
  self.action(&ht_control::SERVICE_TYPE, "IsRemoteConfigured", crate::soap::Unit{}).await
}

async fn learn_ir_code(&self, request: ht_control::LearnIrCodeRequest) -> Result<()> {
  self.action(&ht_control::SERVICE_TYPE, "LearnIRCode", request).await
}

async fn set_ir_repeater_state(&self, request: ht_control::SetIrRepeaterStateRequest) -> Result<()> {
  self.action(&ht_control::SERVICE_TYPE, "SetIRRepeaterState", request).await
}

async fn set_led_feedback_state(&self, request: ht_control::SetLedFeedbackStateRequest) -> Result<()> {
  self.action(&ht_control::SERVICE_TYPE, "SetLEDFeedbackState", request).await
}

}
#[async_trait::async_trait]
impl MusicServicesTrait for SonosDevice {
async fn get_session_id(&self, request: music_services::GetSessionIdRequest) -> Result<music_services::GetSessionIdResponse> {
  self.action(&music_services::SERVICE_TYPE, "GetSessionId", request).await
}

async fn list_available_services(&self) -> Result<music_services::ListAvailableServicesResponse> {
  self.action(&music_services::SERVICE_TYPE, "ListAvailableServices", crate::soap::Unit{}).await
}

async fn update_available_services(&self) -> Result<()> {
  self.action(&music_services::SERVICE_TYPE, "UpdateAvailableServices", crate::soap::Unit{}).await
}

}
#[async_trait::async_trait]
impl QPlayTrait for SonosDevice {
async fn q_play_auth(&self, request: q_play::QPlayAuthRequest) -> Result<q_play::QPlayAuthResponse> {
  self.action(&q_play::SERVICE_TYPE, "QPlayAuth", request).await
}

}
#[async_trait::async_trait]
impl QueueTrait for SonosDevice {
async fn add_multiple_uris(&self, request: queue::AddMultipleUrisRequest) -> Result<queue::AddMultipleUrisResponse> {
  self.action(&queue::SERVICE_TYPE, "AddMultipleURIs", request).await
}
...
async fn attach_queue(&self, request: queue::AttachQueueRequest) -> Result<queue::AttachQueueResponse> {
  self.action(&queue::SERVICE_TYPE, "AttachQueue", request).await
}

async fn backup(&self) -> Result<()> {
  self.action(&queue::SERVICE_TYPE, "Backup", crate::soap::Unit{}).await
}
...
async fn create_queue(&self, request: queue::CreateQueueRequest) -> Result<queue::CreateQueueResponse> {
  self.action(&queue::SERVICE_TYPE, "CreateQueue", request).await
}

async fn remove_all_tracks(&self, request: queue::RemoveAllTracksRequest) -> Result<queue::RemoveAllTracksResponse> {
  self.action(&queue::SERVICE_TYPE, "RemoveAllTracks", request).await
}

async fn remove_track_range(&self, request: queue::RemoveTrackRangeRequest) -> Result<queue::RemoveTrackRangeResponse> {
  self.action(&queue::SERVICE_TYPE, "RemoveTrackRange", request).await
}

async fn reorder_tracks(&self, request: queue::ReorderTracksRequest) -> Result<queue::ReorderTracksResponse> {
  self.action(&queue::SERVICE_TYPE, "ReorderTracks", request).await
}

async fn replace_all_tracks(&self, request: queue::ReplaceAllTracksRequest) -> Result<queue::ReplaceAllTracksResponse> {
  self.action(&queue::SERVICE_TYPE, "ReplaceAllTracks", request).await
}

async fn save_as_sonos_playlist(&self, request: queue::SaveAsSonosPlaylistRequest) -> Result<queue::SaveAsSonosPlaylistResponse> {
  self.action(&queue::SERVICE_TYPE, "SaveAsSonosPlaylist", request).await
}

}
#[async_trait::async_trait]
impl RenderingControlTrait for SonosDevice {
async fn get_bass(&self, request: rendering_control::GetBassRequest) -> Result<rendering_control::GetBassResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetBass", request).await
}

async fn get_eq(&self, request: rendering_control::GetEqRequest) -> Result<rendering_control::GetEqResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetEQ", request).await
}

async fn get_headphone_connected(&self, request: rendering_control::GetHeadphoneConnectedRequest) -> Result<rendering_control::GetHeadphoneConnectedResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetHeadphoneConnected", request).await
}

async fn get_loudness(&self, request: rendering_control::GetLoudnessRequest) -> Result<rendering_control::GetLoudnessResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetLoudness", request).await
}

async fn get_mute(&self, request: rendering_control::GetMuteRequest) -> Result<rendering_control::GetMuteResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetMute", request).await
}

async fn get_output_fixed(&self, request: rendering_control::GetOutputFixedRequest) -> Result<rendering_control::GetOutputFixedResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetOutputFixed", request).await
}

async fn get_room_calibration_status(&self, request: rendering_control::GetRoomCalibrationStatusRequest) -> Result<rendering_control::GetRoomCalibrationStatusResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetRoomCalibrationStatus", request).await
}

async fn get_supports_output_fixed(&self, request: rendering_control::GetSupportsOutputFixedRequest) -> Result<rendering_control::GetSupportsOutputFixedResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetSupportsOutputFixed", request).await
}

async fn get_treble(&self, request: rendering_control::GetTrebleRequest) -> Result<rendering_control::GetTrebleResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetTreble", request).await
}

async fn get_volume(&self, request: rendering_control::GetVolumeRequest) -> Result<rendering_control::GetVolumeResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetVolume", request).await
}

async fn get_volume_db(&self, request: rendering_control::GetVolumeDbRequest) -> Result<rendering_control::GetVolumeDbResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetVolumeDB", request).await
}

async fn get_volume_db_range(&self, request: rendering_control::GetVolumeDbRangeRequest) -> Result<rendering_control::GetVolumeDbRangeResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "GetVolumeDBRange", request).await
}

async fn ramp_to_volume(&self, request: rendering_control::RampToVolumeRequest) -> Result<rendering_control::RampToVolumeResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "RampToVolume", request).await
}

async fn reset_basic_eq(&self, request: rendering_control::ResetBasicEqRequest) -> Result<rendering_control::ResetBasicEqResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "ResetBasicEQ", request).await
}

async fn reset_ext_eq(&self, request: rendering_control::ResetExtEqRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "ResetExtEQ", request).await
}

async fn restore_volume_prior_to_ramp(&self, request: rendering_control::RestoreVolumePriorToRampRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "RestoreVolumePriorToRamp", request).await
}

async fn set_bass(&self, request: rendering_control::SetBassRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetBass", request).await
}

async fn set_channel_map(&self, request: rendering_control::SetChannelMapRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetChannelMap", request).await
}

async fn set_eq(&self, request: rendering_control::SetEqRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetEQ", request).await
}

async fn set_loudness(&self, request: rendering_control::SetLoudnessRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetLoudness", request).await
}

async fn set_mute(&self, request: rendering_control::SetMuteRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetMute", request).await
}

async fn set_output_fixed(&self, request: rendering_control::SetOutputFixedRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetOutputFixed", request).await
}

async fn set_relative_volume(&self, request: rendering_control::SetRelativeVolumeRequest) -> Result<rendering_control::SetRelativeVolumeResponse> {
  self.action(&rendering_control::SERVICE_TYPE, "SetRelativeVolume", request).await
}

async fn set_room_calibration_status(&self, request: rendering_control::SetRoomCalibrationStatusRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetRoomCalibrationStatus", request).await
}

async fn set_room_calibration_x(&self, request: rendering_control::SetRoomCalibrationXRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetRoomCalibrationX", request).await
}

async fn set_treble(&self, request: rendering_control::SetTrebleRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetTreble", request).await
}

async fn set_volume(&self, request: rendering_control::SetVolumeRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetVolume", request).await
}

async fn set_volume_db(&self, request: rendering_control::SetVolumeDbRequest) -> Result<()> {
  self.action(&rendering_control::SERVICE_TYPE, "SetVolumeDB", request).await
}

}
#[async_trait::async_trait]
impl SystemPropertiesTrait for SonosDevice {
async fn add_account_x(&self, request: system_properties::AddAccountXRequest) -> Result<system_properties::AddAccountXResponse> {
  self.action(&system_properties::SERVICE_TYPE, "AddAccountX", request).await
}

async fn add_o_auth_account_x(&self, request: system_properties::AddOAuthAccountXRequest) -> Result<system_properties::AddOAuthAccountXResponse> {
  self.action(&system_properties::SERVICE_TYPE, "AddOAuthAccountX", request).await
}

async fn do_post_update_tasks(&self) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "DoPostUpdateTasks", crate::soap::Unit{}).await
}

async fn edit_account_md(&self, request: system_properties::EditAccountMdRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "EditAccountMd", request).await
}

async fn edit_account_password_x(&self, request: system_properties::EditAccountPasswordXRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "EditAccountPasswordX", request).await
}

async fn enable_rdm(&self, request: system_properties::EnableRdmRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "EnableRDM", request).await
}

async fn get_rdm(&self) -> Result<system_properties::GetRdmResponse> {
  self.action(&system_properties::SERVICE_TYPE, "GetRDM", crate::soap::Unit{}).await
}

async fn get_string(&self, request: system_properties::GetStringRequest) -> Result<system_properties::GetStringResponse> {
  self.action(&system_properties::SERVICE_TYPE, "GetString", request).await
}

async fn get_web_code(&self, request: system_properties::GetWebCodeRequest) -> Result<system_properties::GetWebCodeResponse> {
  self.action(&system_properties::SERVICE_TYPE, "GetWebCode", request).await
}

async fn provision_credentialed_trial_account_x(&self, request: system_properties::ProvisionCredentialedTrialAccountXRequest) -> Result<system_properties::ProvisionCredentialedTrialAccountXResponse> {
  self.action(&system_properties::SERVICE_TYPE, "ProvisionCredentialedTrialAccountX", request).await
}

async fn refresh_account_credentials_x(&self, request: system_properties::RefreshAccountCredentialsXRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "RefreshAccountCredentialsX", request).await
}

async fn remove(&self, request: system_properties::RemoveRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "Remove", request).await
}

async fn remove_account(&self, request: system_properties::RemoveAccountRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "RemoveAccount", request).await
}

async fn replace_account_x(&self, request: system_properties::ReplaceAccountXRequest) -> Result<system_properties::ReplaceAccountXResponse> {
  self.action(&system_properties::SERVICE_TYPE, "ReplaceAccountX", request).await
}

async fn reset_third_party_credentials(&self) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "ResetThirdPartyCredentials", crate::soap::Unit{}).await
}

async fn set_account_nickname_x(&self, request: system_properties::SetAccountNicknameXRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "SetAccountNicknameX", request).await
}

async fn set_string(&self, request: system_properties::SetStringRequest) -> Result<()> {
  self.action(&system_properties::SERVICE_TYPE, "SetString", request).await
}

}
#[async_trait::async_trait]
impl VirtualLineInTrait for SonosDevice {
async fn next(&self, request: virtual_line_in::NextRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "Next", request).await
}

async fn pause(&self, request: virtual_line_in::PauseRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "Pause", request).await
}

async fn play(&self, request: virtual_line_in::PlayRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "Play", request).await
}

async fn previous(&self, request: virtual_line_in::PreviousRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "Previous", request).await
}

async fn set_volume(&self, request: virtual_line_in::SetVolumeRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "SetVolume", request).await
}

async fn start_transmission(&self, request: virtual_line_in::StartTransmissionRequest) -> Result<virtual_line_in::StartTransmissionResponse> {
  self.action(&virtual_line_in::SERVICE_TYPE, "StartTransmission", request).await
}

async fn stop(&self, request: virtual_line_in::StopRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "Stop", request).await
}

async fn stop_transmission(&self, request: virtual_line_in::StopTransmissionRequest) -> Result<()> {
  self.action(&virtual_line_in::SERVICE_TYPE, "StopTransmission", request).await
}

}
#[async_trait::async_trait]
impl ZoneGroupTopologyTrait for SonosDevice {
async fn begin_software_update(&self, request: zone_group_topology::BeginSoftwareUpdateRequest) -> Result<()> {
  self.action(&zone_group_topology::SERVICE_TYPE, "BeginSoftwareUpdate", request).await
}

async fn check_for_update(&self, request: zone_group_topology::CheckForUpdateRequest) -> Result<zone_group_topology::CheckForUpdateResponse> {
  self.action(&zone_group_topology::SERVICE_TYPE, "CheckForUpdate", request).await
}

async fn get_zone_group_attributes(&self) -> Result<zone_group_topology::GetZoneGroupAttributesResponse> {
  self.action(&zone_group_topology::SERVICE_TYPE, "GetZoneGroupAttributes", crate::soap::Unit{}).await
}

async fn get_zone_group_state(&self) -> Result<zone_group_topology::GetZoneGroupStateResponse> {
  self.action(&zone_group_topology::SERVICE_TYPE, "GetZoneGroupState", crate::soap::Unit{}).await
}

async fn register_mobile_device(&self, request: zone_group_topology::RegisterMobileDeviceRequest) -> Result<()> {
  self.action(&zone_group_topology::SERVICE_TYPE, "RegisterMobileDevice", request).await
}

async fn report_alarm_started_running(&self) -> Result<()> {
  self.action(&zone_group_topology::SERVICE_TYPE, "ReportAlarmStartedRunning", crate::soap::Unit{}).await
}

async fn report_unresponsive_device(&self, request: zone_group_topology::ReportUnresponsiveDeviceRequest) -> Result<()> {
  self.action(&zone_group_topology::SERVICE_TYPE, "ReportUnresponsiveDevice", request).await
}

async fn submit_diagnostics(&self, request: zone_group_topology::SubmitDiagnosticsRequest) -> Result<zone_group_topology::SubmitDiagnosticsResponse> {
  self.action(&zone_group_topology::SERVICE_TYPE, "SubmitDiagnostics", request).await
}
